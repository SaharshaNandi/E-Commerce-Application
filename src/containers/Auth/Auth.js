...
class Auth extends Component {
  ...
  render() {
    ...
    let title = <h1 className="auth-title">Don't have an account yet? Sign Up now.</h1>
    if (!isSignup) title = <h1 className="auth-title">Already have an account? Log in.</h1>;
        ...
        <div className="auth-container">
          ...
          <div className="switch">
            <Button
              ...
              btnType="dark">Switch to {isSignup ? 'Sign-IN' : 'Sign-UP'}</Button>
          </div>
          {authRedirect}
          {errorMessage}
